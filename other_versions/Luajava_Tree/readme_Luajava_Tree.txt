...
Input and output file for Tree_Luajava_Windows.lua.

3. Tree_Luajava_output.txt

This is the output file for the paths of the tree. It is written at the load of the tree and after changes of it.
