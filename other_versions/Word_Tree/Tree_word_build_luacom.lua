...
--3. function to collect data recursively from Lua table for the tree
...
docNew.Paragraphs(numberOfParagraph).Style="Ãœberschrift " .. math.max(-(level+2),-10) --https://docs.microsoft.com/en-us/office/vba/api/Word.WdBuiltinStyle
...
--4. apply the recursive function
AusgabeTabelle={}
